public class SelectMenuName
{
    public const string uiRooot = "UIRoot";

    public const string headUp = "HeadPanel/Up";
    public const string headDown = "HeadPanel/Down";
    public const string handUp = "HandPanel/Up";
    ...
    public const string cyanButton = colorPanel + "/Cyan";
